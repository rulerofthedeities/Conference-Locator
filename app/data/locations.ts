...
export const HOTELS: Hotels[] = [
	...
	new Hotel(2.32538, 48.87315),
	new Hotel(2.32459, 48.88144),
	new Hotel(2.34954, 48.84324)
];

HOTELS[0].name = 'Hilton Prague';
HOTELS[1].name = 'Hotel Ametyst';
HOTELS[2].name = 'Hotel International Prague';
...
SIGHTS[2].name = 'Old Town Square';
SIGHTS[3].name = 'St. Vitus Cathedral';
